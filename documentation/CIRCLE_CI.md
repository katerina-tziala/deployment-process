...
Many developers will commit and push code to the remote GitHub repository.

When merging a Pull Request to the main branch the main CircleCI pipeline will be triggred deploying thus both the api and the front end.
